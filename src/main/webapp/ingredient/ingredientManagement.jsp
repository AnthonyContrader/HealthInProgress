      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <h3 class="page-header"><i class="fa fa-laptop"></i> Ingredients Management</h3>

            <ol class="breadcrumb">

              <li><i class="fa fa-home"></i>Home</a></li>

              <li><i class="fa fa-laptop"></i>Ingredients Management</li>
		...
		<tr><th>Id</th><th>Nome</th><th colspan=2>Manage</th></tr>

		<%

			for(IngredientDTO ingredient: listIngredient){
