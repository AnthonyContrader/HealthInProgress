      ...
      <section class="wrapper">
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        		<form class="insert-form" action="/Sport/insert" method="post">
		<table>
			<tr>
				<td>Nome sport</td><td><input type="text" name="nome" placeholder="nome"></td>
			</tr>
				<tr>
				<td>tipo sport</td><td><input type="text" name="tipo" placeholder="tipo"></td>
			</tr>
				<tr>
				<td>durata sport</td><td><input type="text" name="durata" placeholder="durata"></td>
			</tr>
