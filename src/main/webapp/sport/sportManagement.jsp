 <%@page import="it.contrader.model.Sport"%>
...
<title>Sport Management</title>
	...
	<%
		...
		List<SportDTO> listSport  = (List<SportDTO>) request.getAttribute("allSportDTO");
...
<body>
  ...
  <section id="container" class="">
      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <h3 class="page-header"><i class="fa fa-laptop"></i> Sport Management</h3>

            <ol class="breadcrumb">

              <li><i class="fa fa-home"></i>Home</a></li>

              <li><i class="fa fa-laptop"></i>Sport Management</li>
		...
		<tr><th>IdSport</th><th>nomeSport</th><th>Tipo</th><th>duarata</th><th colspan=2>Manage</th></tr>

		<%

			for(SportDTO sport: listSport){
		 ...
		 %>
		 	...
		 	<tr>
		 		...
		 		<td><a class="btn btn-primary btn-lg btn-block" href="/Sport/delete?id=<%=sport.getIdSport()%>">Delete</a></td>

		 		<td><a class="btn btn-primary btn-lg btn-block"href="/Sport/updateRedirect?id=<%=sport.getIdSport()%>">Update</a></td>
	...
	<a class="btn btn-primary btn-lg btn-block" href="/sport/insertSport.jsp">Insert new Sport</a>
