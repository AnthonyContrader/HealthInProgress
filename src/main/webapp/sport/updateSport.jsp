...
<%
	 SportDTO  sportUpdate = (SportDTO) request.getAttribute("sportUpdate");
%>
<meta charset="utf-8">
			...
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> Sport Update
						</h3>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form method="POST" action="/Sport/update">
							<input type="hidden" name="idSport" value="<%=sportUpdate.getIdSport()%>" />
							<table class="table">

								<tr>
									<td><b>Name:</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="nome" value="<%=sportUpdate.getNome()%>" /></td>
								</tr>
								
								<tr>
									<td><b>Tipo :</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="tipo" value="<%=sportUpdate.getTipo()%>" /></td>
								</tr>
								
								<tr>
									<td><b>Durata:</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="durata" value="<%=sportUpdate.getDurata()%>" /></td>
								</tr>
...
<br> <br>
						<a class="btn btn-primary btn-lg btn-block"
							href="/Sport/sportManagement">Back</a>
