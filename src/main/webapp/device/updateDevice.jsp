...
<%
	DeviceDTO deviceUpdate = (DeviceDTO) request.getAttribute("deviceUpdate");
%>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> Device Update
						</h3>
						<ol class="breadcrumb">
							...
							<table class="table">
								...
								<tr>
									...
									<td><input type="text" size="40" maxlength="40"
										name="nome" value="<%=deviceUpdate.getNome()%>" /></td>
								</tr>
...
<br> <br>
						<a class="btn btn-primary btn-lg btn-block"
							href="/Device/deviceManagement">Back</a>
