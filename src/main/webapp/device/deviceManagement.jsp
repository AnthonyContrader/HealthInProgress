...
<title>Device Management</title>
	...
	<%
		...
		List<DeviceDTO> listDevice = (List<DeviceDTO>) request.getAttribute("allDeviceDTO");
...
<body>
  ...
  <section id="container" class="">
      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <h3 class="page-header"><i class="fa fa-laptop"></i> Device Management</h3>

            <ol class="breadcrumb">

              <li><i class="fa fa-home"></i>Home</a></li>

              <li><i class="fa fa-laptop"></i>Device Management</li>
		...
		<tr><th>IdDevice</th><th>nome</th><th colspan=2>Manage</th></tr>
		...
		<%
		 ...
		 %>
		 	...
		 	<tr>
		 		...
		 		<td><a class="btn btn-primary btn-lg btn-block" href="/Device/delete?id=<%=device.getId() %>">Delete</a></td>

		 		<td><a class="btn btn-primary btn-lg btn-block"href="/Device/updateRedirect?id=<%=device.getId()%>">Update</a></td>
	...
	<a class="btn btn-primary btn-lg btn-block" href="/device/insertDevice.jsp">Insert new Device</a>
