...
<head>
	...
	<title>Login HealthInProgress</title>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="/User/login" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid password is required">
						...
						<input class="input100" type="nome" name="username">
...
<li><a class="" href="/User/registerUser">Register</a></li></a>
				...
				<div class="login100-more" style="background-image: url(''); width: 800px;

    height:800px; align: left">
