...
<%@	page import="it.contrader.dto.MealDTO"%>
...
<title>Meal Management</title>
	...
	<%
		...
		List<MealDTO> listMeal  = (List<MealDTO>) request.getAttribute("allMealDTO");
...
<body>
  ...
  <section id="container" class="">
      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <h3 class="page-header"><i class="fa fa-laptop"></i> Meal Management</h3>

            <ol class="breadcrumb">

              <li><i class="fa fa-home"></i>Home</a></li>

              <li><i class="fa fa-laptop"></i>Meal Management</li>
		...
		<tr><th>IdPiatto</th><th>Nome</th><th>Kcal</th><th>tipo</th><th colspan=2>Manage</th></tr>

		<%

			for(MealDTO meal: listMeal){

		 %>

		 	<tr>

		 		<td><%=meal.getIdPiatto()%></td>
		 		<td><%=meal.getNome()%></td>
		 		<td><%=meal.getKcal()%></td>
		 		<td><%=meal.getTipo()%></td>
		 		...
		 		<td><a class="btn btn-primary btn-lg btn-block" href="/Meal/delete?id=<%=meal.getIdPiatto()%>">Delete</a></td>

		 		<td><a class="btn btn-primary btn-lg btn-block"href="/Meal/updateRedirect?id=<%=meal.getIdPiatto()%>">Update</a></td>
	...
	<a class="btn btn-primary btn-lg btn-block" href="/meal/insertMeal.jsp">Insert new piatto</a>
