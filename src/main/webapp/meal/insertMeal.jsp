  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Insert sport</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Home</a></li>
              <li><i class="fa fa-laptop"></i>Insert sport</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        		<form class="insert-form" action="/Meal/insert" method="post">
		<table>
			<tr>
				<td>Nome Meal</td><td><input type="text" name="nome" placeholder="nome"></td>
			</tr>
				<tr>
				<td>kcal Meal</td><td><input type="text" name="kcal" placeholder="kcal"></td>
			</tr>
				<tr>
				<td>tipo Meal</td><td><input type="text" name="tipo" placeholder="tipo"></td>
			</tr>
	...
	<br>
	<a class="btn btn-primary btn-lg btn-block" href="/meal/mealManagement">Back</a>
            </div>
        </div>
