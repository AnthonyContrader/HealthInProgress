...
<%
	 MealDTO  mealUpdate = (MealDTO) request.getAttribute("mealUpdate");
%>
<meta charset="utf-8">
			...
			<div class="top-nav notification-row">
				...
				<ul class="nav pull-right top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#"> <span class="username">${utenteCollegato}</span>
							<b class="caret"></b>
					</a>
						<ul class="dropdown-menu extended logout">
							<div class="log-arrow-up"></div>
							<li><a href="/User/logout"><i class="icon_key_alt"></i>
									Log Out</a></li>
						</ul></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-laptop"></i> Meal Update
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="fa fa-laptop"></i>Meal Update</li>
						</ol>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<form method="POST" action="/Meal/update">
							<input type="hidden" name="idPiatto" value="<%=mealUpdate.getIdPiatto()%>" />
							<table class="table">

								<tr>
									<td><b>Name:</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="nome" value="<%=mealUpdate.getNome()%>" /></td>
								</tr>
								
								<tr>
									<td><b>kcal :</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="kcal" value="<%= mealUpdate.getKcal()%>" /></td>
								</tr>
								
								<tr>
									<td><b>tipo:</b></td>
									<td><input type="text" size="40" maxlength="40"
										name="tipo" value="<%=mealUpdate.getTipo()%>" /></td>
								</tr>
...
<br> <br>
						<a class="btn btn-primary btn-lg btn-block"
							href="/Meal/mealManagement">Back</a>
