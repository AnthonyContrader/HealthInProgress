  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Insert Parameter</h3>
            <ol class="breadcrumb">
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        		<form class="insert-form" action="/Parameter/insert" method="post">
		<table>
			<tr>
				<td>Sesso</td><td> <select  id="n1" name ="sesso">
            					<option value="Maschio">Maschio</option>
          						  <option value="Femina">Femina</option>
        </select></td>
			</tr>
			<tr>
				<td>Altezza</td><td> <input type="text" size="40" maxlength="40" name="altezza" id ="n2" class="rightAligned"/></td>
			</tr>
			<tr>
				<td>Peso</td><td><input type="text" size="40" maxlength="40" name="peso" id ="n3" class="rightAligned"/></td>
			</tr>
			<tr>
				<td>Eta</td><td><input type="text" size="40" maxlength="40" name="eta"  id ="n4"class="rightAligned"/></td>
			</tr>
			<tr>
				<td>TotKcal</td><td><input type="text" name="totKcal" placeholder="totKcal" id="result"></td>
			</tr>
